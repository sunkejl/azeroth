...
import gateway.filter.HeaderHttpMyResponseFilter;
...
public class HttpOutboundHandler {
    ...
    HttpResponseFilter filter01 = new HeaderHttpMyResponseFilter();
    ...
    public void handlerHomework(FullHttpRequest fullRequest, ChannelHandlerContext ctx) {
        FullHttpResponse response = null;
        try {
            List<NameValuePair> nameValuePairList = new ArrayList<>();
            String value = HttpClientUtil.getData("http://localhost:8803", nameValuePairList);
